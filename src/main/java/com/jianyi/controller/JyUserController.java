...
import com.jianyi.util.MD5Util;
...
public class JyUserController {
    ...
    public JSONObject login(String _id, String password, HttpSession session){
        ...
        return jyUserService.Verification(_id, passwordMD5,session);
    }
    ...
    public JSONObject changepassword(String user_oldpassword ,String password,String _id){
        JSONObject jsonObject=new JSONObject();
        String oldpasswordMD5 = MD5Util.MD5Encode(user_oldpassword,"UTF-8");
        String passwordMD5 = MD5Util.MD5Encode(password,"UTF-8");
        int code4 = jyUserService.isture(oldpasswordMD5,passwordMD5,_id);
        if ( code4 == 1)
        {
            jsonObject.put("code",0);
            jsonObject.put("data",null);
    ...
    public JSONObject change(String _id,String password){
        JSONObject jsonObject = new JSONObject();
        String passwordMD5 = MD5Util.MD5Encode(password,"UTF-8");
        int number2 = jyUserService.change(passwordMD5,_id);
        if (number2 == 1)
        {
            jsonObject.put("code",-1);
            jsonObject.put("data",null);
